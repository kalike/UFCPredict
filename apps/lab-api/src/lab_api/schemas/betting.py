...
class BacktestResponse(BaseModel):
    ...
    # Aggregate of singles+doubles+triples (excludes baseline). Its max_drawdown
    # is computed over the COMBINED cumulative PnL of the three bet types.
    total: StrategyResult | None = None
    best_strategy: str
    total_events: int
